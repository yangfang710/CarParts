	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/CarParts/CartItemServlet?method=batchDelete&cartItemIds=" + id;
			}
		} else {
...
function batchDelete() {
	...
	location = "/CarParts/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
}
...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="70px">
			<a class="linkImage" href="<c:url value='/jsps/car/desc.jsp'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.car.image_b }'/>"/></a>
		</td>
		<td align="left" width="400px">
		    <a href="<c:url value='/jsps/car/desc.jsp'/>"><span>${cartItem.car.cname }</span></a>
		</td>
		<td><span>&yen;<span class="currPrice">${cartItem.car.currPrice }</span></span></td>
		<td>
	...
	<tr>
		<td colspan="7" align="right">
			<a href="javascript:jiesuan();" id="jiesuan" class="jiesuan"><img src='<c:url value="/images/jiesuan.png" />'></a>
		</td>
	</tr>
</table>
