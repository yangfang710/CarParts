...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		...
		<td>&yen;${cartItem.car.currPrice }</td>
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="重庆市 南岸区  崇文路2号 重庆邮电大学  XXX收"/>
		</td>
	</tr>
	<tr>
		<td style="border-top-width: 4px;" colspan="5" align="right">
			<a id="linkSubmit" href="javascript:$('#form1').submit();"><img src='<c:url value="/images/order.png" />' /></a>
		</td>
	</tr>
</table>
</form>
