$(function() {
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/CarParts/images/login2.png");
		},
		function() {
			$("#submit").attr("src", "/CarParts/images/login1.png");
		}
	);
	$("#registBtn").hover(
			function() {
				$("#registBtn").attr("src", "/CarParts/images/register2.png");
			},
			function() {
				$("#registBtn").attr("src", "/CarParts/images/register1.png");
			}
		);
	/*
