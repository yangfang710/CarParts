$(function() {
	...
	$("#submitBtn").hover(
		function() {
			$("#submitBtn").attr("src", "/CarParts/images/register.png");
		},
		function() {
			$("#submitBtn").attr("src", "/CarParts/images/register.png");
		}
...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/CarParts/UserServlet",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/CarParts/VerifyCodeServlet?a=" + new Date().getTime());
}
