...
<div class="divBank">
	...
	<div style="margin-left: 20px;">
	  ...
	  <div style="margin-bottom: 20px;">
	  	<input id="ZFB" type="radio" name="yh" value="ZFB"/>
		<img name="ZFB" align="middle" src="<c:url value='/bank_img/zfb.jpg'/>"/>
	  </div>
	</div>
	<div style="text-align:right;margin: 40px;">
		<a href="javascript:void $('#form1').submit();" class="linkNext"><img src='<c:url value="/images/next.png" />' /></a>
	</div>
</div>
</form>
  </body>
