...
public class CategoryDao {
	...
	private Category toCategory(Map<String, Object> map) {
		/*
		 * map {cid:xx, cname:xx, pid:xx, desc:xx, orderBy:xx} Category{cid:xx,
		 * cname:xx, parent:(cid=pid), desc:xx}
		 */
	...
	public void add(Category category) throws SQLException {
		String sql = "insert into t_category(cid,catName,pid,`desc`) values(?,?,?,?)";
		/*
		...
		Object[] params = { category.getCid(), category.getCatName(), pid,
				category.getDesc() };
	...
	public void edit(Category category) throws SQLException {
		String sql = "update t_category set catName=?, pid=?, `desc`=? where cid=?";
		String pid = null;
		if (category.getParent() != null) {
			pid = category.getParent().getCid();
		}
		Object[] params = { category.getCatName(), pid, category.getDesc(),
				category.getCid() };
		qr.update(sql, params);
	}
