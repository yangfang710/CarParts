...
import lang.hong.shuai.dao.BookDao;
import lang.hong.shuai.domain.Book;
...
public class BookService {
	 ...
	 * @return
	 */
	public PageBean<Book> findByPrice(String currPrice, int pc) {
		try {
			return bookDao.findByCurrPrice(currPrice, pc);
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
